...
import { Shield, Home, ScanLine, ClipboardCheck, Users, Activity, LogOut } from 'lucide-react';
...
const navItems: { label: string; href: string; icon: React.ReactNode; page: ActivePage }[] = [
  ...
  { label: 'Attendance Log', href: '/officer/attendance', icon: <ClipboardCheck className="w-5 h-5" />,page: 'attendance' },
